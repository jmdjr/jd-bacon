...
{
    // A Camera that is designed to follow a hero around the world, staying a specific distance and 
    public class JDHeroCamera : JDCamera
    {
        /// <summary>
        /// Initializes new camera component.
        /// </summary>
        /// <param name="game">Game to which attach this camera.</param>
        public JDHeroCamera(Game game, JDCameraObject cameraObject)
