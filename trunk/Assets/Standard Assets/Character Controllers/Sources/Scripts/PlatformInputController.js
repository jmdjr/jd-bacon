...
function Update () {
	...
	//Debug.Log(GameObject.FindGameObjectWithTag("PlayerModel").GetComponent("MyCharController").IsLiving());
	if (GameObject.FindGameObjectWithTag("PlayerModel").GetComponent("MyCharController").IsLiving())
	{
