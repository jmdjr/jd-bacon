...
public class CharacterAnimationHelper : JDIAnimator
{
    ...
    public CharacterAnimationHelper(BoneAnimation bone, HeroAnimationType initialAnimation = HeroAnimationType.S_IDLE | HeroAnimationType.W_NONE | HeroAnimationType.D_STRAIT)
    {
        if (bone == null)
        {
