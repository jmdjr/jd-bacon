...
{
    public class FlatLand : DrawableGameComponent
    {
        ...
        public FlatLand(Game game, float size)
            : base(game)
        {
            this.size = size;
        }
        ...
        {
            JDBaconTheGame demo = this.Game as JDBaconTheGame;

            GraphicsDevice.SamplerStates[0] = SamplerState.AnisotropicWrap;
            GraphicsDevice.DepthStencilState = DepthStencilState.Default;

            effect.View = demo.CameraReference.View;
            effect.Projection = demo.CameraReference.Projection;
